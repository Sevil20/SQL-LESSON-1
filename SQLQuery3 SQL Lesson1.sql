...
INSERT INTO categories2 (CategoryID, CategoryName, Description) VALUES
...
INSERT INTO orders2 (OrderID, CustomerID, EmployeeID, OrderDate, ShipperID) VALUES
...
INSERT INTO order_details2 (OrderDetailID, OrderID, ProductID, Quantity) VALUES
(1, 10248, 11, 12),
(2, 10248, 42, 10),
(3, 10248, 72, 5),
(4, 10249, 14, 9),
...
INSERT INTO products2 (ProductID, ProductName, SupplierID, CategoryID, Unit, Price) VALUES
...
INSERT INTO shippers2 (ShipperID, ShipperName, Phone) VALUES
...
INSERT INTO suppliers2 (SupplierID, SupplierName, ContactName, Address, City, PostalCode, Country, Phone) VALUES
...
use SQLLesson2
select * from categories2,customers2,employees2,orders2,order_details2, products2,shippers2,suppliers2
--Productun adı, malı göndərənin (şirkətin) adı, kateqoriyanın adını select edən sorğuunu yazın.
select P.ProductName, S.SupplierName,C.CategoryName from products2 as P,suppliers2 as S,categories2 as C
-- Sifarişlərin İD - sini, sifarişin tarixini (formatı belə olsun -> Jun 15 2023), müştərinin adını, adresini, ölkəsini, sifarişi göndərən işçinin (employer) ad və soyadını 1 sütunda, yükü göndərənin(shipper) adı, yükü göndərənin telefon nömrəsini select edin və ən yeni sifarişlərdən ən köhnəsinə görə sıralayın.
select O.OrderID, Format(OrderDate,'MMM/dd/yy','en-US'),C.CustomerName ,C.Address, C.Country  from  orders2 as O, customers2 as C 